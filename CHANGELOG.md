...
- Turns.
- King check.
- Background color for the king in check.
- Checkmate.
- Stalemate.
- Castling.
- En passant.
...
- Now all chess pieces inherit from their own ChessPiece abstract class.
- README
...
[0.4.0]: https://github.com/srjheam/console-chess/compare/v0.3.0...v0.4.0
